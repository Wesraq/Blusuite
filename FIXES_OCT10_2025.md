...
**Solution:** Restricted theme toggle to ADMIN and SUPERADMIN only:
...
**Result:** 
- ✅ Only ADMIN and SUPERADMIN users see the theme toggle button
- ✅ Tenant companies (ADMINISTRATOR, EMPLOYER_ADMIN, etc.) stay in light theme
