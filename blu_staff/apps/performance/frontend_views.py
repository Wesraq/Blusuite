...
class ReviewCreateView(LoginRequiredMixin, UserPassesTestMixin, CompanyContextMixin, CreateView):
    ...
    def test_func(self):
        return self.request.user.role in ['EMPLOYER_SUPERUSER', 'EMPLOYER_ADMIN', 'ADMINISTRATOR', 'SUPERADMIN']
...
class ReviewUpdateView(LoginRequiredMixin, UserPassesTestMixin, CompanyContextMixin, UpdateView):
    ...
    def test_func(self):
        ...
        return (
            ...
            self.request.user.role in ['EMPLOYER_SUPERUSER', 'EMPLOYER_ADMIN', 'ADMINISTRATOR', 'SUPERADMIN']
        )
